...
/**
 * Foreground service that keeps the {@code com.qinggan.app.launcher} process
 ...
 * notification. The actual launcher business logic (weather polling, app-launch
 * simulation, media source updates) is intentionally minimal here: the daemon
 * injects Frida agents that patch the real classes at runtime, so the host
 * process only needs to stay alive.
 */
public class LauncherService extends Service {
    ...
    private static final String CHANNEL_ID = "voboost_launcher_foreground";
    ...
    private static final String CHANNEL_NAME = "Launcher stub foreground service";
    ...
    public final void onCreate() {
        ...
        startKeepAliveLoop();
        Log.i(TAG, "Launcher foreground service started");
    }
    ...
    public void onDestroy() {
        ...
        Log.i(TAG, "Launcher foreground service destroyed");
        super.onDestroy();
    }
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setDescription("Keeps the launcher process alive for Frida injection");
