...
/**
 * Foreground service that keeps the {@code com.qinggan.bluetoothphone} process
 ...
 * notification. The actual BluetoothPhone business logic is intentionally minimal
...
public class BluetoothPhoneService extends Service {
    ...
    private static final String CHANNEL_ID = "voboost_bluetoothphone_foreground";
    ...
    private static final String CHANNEL_NAME = "BluetoothPhone stub foreground service";
    ...
    public final void onCreate() {
        ...
        startKeepAliveLoop();
        Log.i(TAG, "BluetoothPhone foreground service started");
    }
    ...
    public void onDestroy() {
        ...
        Log.i(TAG, "BluetoothPhone foreground service destroyed");
        super.onDestroy();
    }
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setDescription("Keeps the BluetoothPhone process alive for Frida injection");
    ...
    private Notification buildNotification() {
        return new Notification.Builder(this, CHANNEL_ID)
            .setContentTitle("BluetoothPhone stub")
    ...
    public static void start(final Context context) {
        Intent intent = new Intent(context, BluetoothPhoneService.class);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
