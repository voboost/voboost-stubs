...
export const STUB_INIT_PATTERNS = {
    launcher: [
        '[com.qinggan.app.launcher] Starting Kotlin stub application',
        '[com.qinggan.app.launcher] Ready for Frida injection',
    ],
    bluetoothphone: [
        '[com.qinggan.bluetoothphone] Starting Kotlin stub application',
        '[com.qinggan.bluetoothphone] Ready for Frida injection',
    ],
    systemservice: [
        '[com.qinggan.systemservice] Starting Kotlin stub application',
        '[com.qinggan.systemservice] Ready for Frida injection',
    ],
    qgime: [
        '[com.qinggan.app.qgime] Starting Kotlin stub application',
        '[com.qinggan.app.qgime] Ready for Frida injection',
    ],
    vehiclesetting: [
        '[com.qinggan.app.vehiclesetting] Starting Kotlin stub application',
