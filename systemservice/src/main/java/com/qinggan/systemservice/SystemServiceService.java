...
/**
 * Foreground service that keeps the {@code com.qinggan.systemservice} process
 ...
 * notification. The actual SystemService business logic is intentionally minimal
 * here: the daemon injects Frida agents that patch the real classes at runtime,
 * so the host process only needs to stay alive.
 */
public class SystemServiceService extends Service {
    /** Log tag. */
    private static final String TAG = "SystemServiceService";

    /** Notification channel id (low importance, no sound). */
    private static final String CHANNEL_ID = "voboost_systemservice_foreground";
    ...
    private static final String CHANNEL_NAME = "SystemService stub foreground service";
    ...
    public final void onCreate() {
        ...
        startKeepAliveLoop();
        Log.i(TAG, "SystemService foreground service started");
    }
    ...
    public void onDestroy() {
        ...
        Log.i(TAG, "SystemService foreground service destroyed");
        super.onDestroy();
    }
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setDescription("Keeps the SystemService process alive for Frida injection");
    ...
    private Notification buildNotification() {
        return new Notification.Builder(this, CHANNEL_ID)
            .setContentTitle("SystemService stub")
    ...
    public static void start(final Context context) {
        Intent intent = new Intent(context, SystemServiceService.class);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
