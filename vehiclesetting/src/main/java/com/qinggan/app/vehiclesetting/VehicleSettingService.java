...
/**
 * Foreground service that keeps the {@code com.qinggan.app.vehiclesetting}
 * process alive so the voboost-inject daemon can spawn-gate / attach Frida
 * agents to it.
 *
 * <p>The service runs in the foreground with a persistent low-priority
 * notification. The actual VehicleSetting business logic is intentionally
 * minimal here: the daemon injects Frida agents that patch the real classes at
 * runtime, so the host process only needs to stay alive.
 */
public class VehicleSettingService extends Service {
    /** Log tag. */
    private static final String TAG = "VehicleSettingService";

    /** Notification channel id (low importance, no sound). */
    private static final String CHANNEL_ID = "voboost_vehiclesetting_foreground";
    ...
    private static final String CHANNEL_NAME = "VehicleSetting stub foreground service";
    ...
    public final void onCreate() {
        ...
        startKeepAliveLoop();
        Log.i(TAG, "VehicleSetting foreground service started");
    }
    ...
    public void onDestroy() {
        ...
        Log.i(TAG, "VehicleSetting foreground service destroyed");
        super.onDestroy();
    }
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setDescription("Keeps the VehicleSetting process alive for Frida injection");
    ...
    private Notification buildNotification() {
        return new Notification.Builder(this, CHANNEL_ID)
            .setContentTitle("VehicleSetting stub")
    ...
    public static void start(final Context context) {
        Intent intent = new Intent(context, VehicleSettingService.class);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
